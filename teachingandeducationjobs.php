...
<head>
    <meta charset="utf-8">
    <title>Teaching & Education Jobs</title>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container my-5 job-card mx-auto div-border">
            ...
            <p><i class="fas fa-user-group"></i> SKIT</p>
            <p><i class="fas fa-map-marker-alt"></i> Jaipur</p>
            <p><i class="fas fa-clock"></i> Posted 2 days ago</p>
            <p class="job-description">
                About Us: Swami Keshvanand Institute of Technology, Management & Gramothan (SKIT) inspired from the learnings of Swami Keshvanand, was established in the year 2000 by Technocrats and Managers Society of Advanced Learning and Gramothan. 
            </p>
            <button class="view-details-btn">View Salary & Details</button>
            <button class="view-details-btn">Apply Now</button>
        </div>
        <div class="container my-5 job-card mx-auto div-border">
            <h3>Maths Professor</h3>
            <p><i class="fas fa-user-group"></i> SKIT</p>
            <p><i class="fas fa-map-marker-alt"></i> Jaipur</p>
            <p><i class="fas fa-clock"></i> Posted 2 days ago</p>
            <p class="job-description">
        ...
        <div class="container my-5 job-card mx-auto div-border">
            <h3>Mechatronics Lab Assistant</h3>
            <p><i class="fas fa-user-group"></i> SKIT</p>
            <p><i class="fas fa-map-marker-alt"></i> Jaipur</p>
            <p><i class="fas fa-clock"></i> Posted 2 days ago</p>
            <p class="job-description">
