...
VALUES (1, 'Proteen Das', 'admin@admin.com', 'password');
...
-- Insert sample data
INSERT INTO `totalactiveusers` (`TotalActiveUsers`) 
VALUES (25), (42), (55);
...
CREATE TABLE `totalposts` (
  `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `AllPosts` INT NOT NULL
);

INSERT INTO `totalposts` (`AllPosts`)
VALUES (100);  -- Example value: 100 total posts
