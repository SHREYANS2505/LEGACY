...
<head>
    <meta charset="utf-8">
    <title>Project Management Jobs</title>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container my-5 job-card mx-auto div-border">
            <h3>Product Sales Manager</h3>
            <p><i class="fas fa-user-group"></i> TLS DigiTech Pvt. Ltd.</p>
            <p><i class="fas fa-map-marker-alt"></i> Jaipur</p>
            <p><i class="fas fa-clock"></i> Posted 2 days ago</p>
            <p class="job-description">
                About Us: TLC DigiTech Pvt. Ltd. is an innovative, marketing-oriented, design-led organization, uniquely providing a complete suite of solutions across digital, tech and services. 
            </p>
