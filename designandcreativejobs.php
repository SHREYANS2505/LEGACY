...
<head>
    <meta charset="utf-8">
    <title>Design & Creative Jobs</title>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container my-5 job-card mx-auto div-border">
            <h3>Jewelery Designer</h3>
            <p><i class="fas fa-user-group"></i> Anu Merton</p>
            <p><i class="fas fa-map-marker-alt"></i> Jaipur</p>
            <p><i class="fas fa-clock"></i> Posted 2 days ago</p>
            <p class="job-description">
                About Us: Anu Merton is a new eCommerce brand based in Bangalore & Jaipur with a mission to share the great Indian jewellery tradition with the make affordable, handmade Indian jewellery and apparel available to the whole world.“At Anu Merton’s jewellery store, you’ll find fantastical handmade jewellery pieces that have been moulded and crafted fondly across J.
            </p>
            <button class="view-details-btn">View Salary & Details</button>
            <button class="view-details-btn">Apply Now</button>
        </div>
        <div class="container my-5 job-card mx-auto div-border">
            <h3>Graphic Designer</h3>
            <p><i class="fas fa-user-group"></i> RoboMQ</p>
            <p><i class="fas fa-map-marker-alt"></i> Jaipur</p>
            <p><i class="fas fa-clock"></i> Posted 2 days ago</p>
            <p class="job-description">
                About Us: RoboMQ is an API and data integration company that enables enterprises to automate critical business processes to reduce cost, improve operational effectiveness, and provide better customer and employee experience. RoboMQ offers Hire2Retire, a Lightweight IGA (Identity, Governance, and Administration) SaaS product that manages employee life.
            </p>
            <button class="view-details-btn">View Salary & Details</button>
            <button class="view-details-btn">Apply Now</button>
        </div>
        <div class="container my-5 job-card mx-auto div-border">
            <h3>Lead Designer</h3>
            <p><i class="fas fa-user-group"></i> Trunks Company</p>
            <p><i class="fas fa-map-marker-alt"></i> Jaipur</p>
            <p><i class="fas fa-clock"></i> Posted 2 days ago</p>
            <p class="job-description">
                About Us: Trunks company established in 2011, explores an unparallel realm in the world of Trunks, our story of passion, perseverance and creative expression is inspired by our roots and defying conventional imagination, thus establishing an industry of our own. Since inception we have been encapsulating emotions and passions those of aficionad."
            </p>
            <button class="view-details-btn">View Salary & Details</button>
            <button class="view-details-btn">Apply Now</button>
        </div>
