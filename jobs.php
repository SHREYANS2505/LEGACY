  ...
  <head>
    ...
    <title> Legacy | Job Listings </title>
  ...
  ?>
          <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #f2cc8f; padding-left:4px;">
              Total Job Posts Available: <?php echo $numberofposts; ?>
          </h3>
  <?php }
  } ?>
...
if (!$userresult) {
    // This will display the error if the query fails
...
if ($userresult->num_rows > 0) {
    ...
    echo "<h3 style=\"font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #f2cc8f; padding-left:4px;\">
            Active Users: {$numberofusers}
          </h3>";
} else {
    echo "No active users data available.";
}
?>
              ...
              <div class="row">
                ...
                ?>
                    ...
                    <div class="col-md-4 crd" style="margin: 20px; background-color:#257059; padding: 20px;">
                      ...
                      <!-- ------------------------------------------------------------------ -->
                      <a href="applyJob.php?id=<?php echo $pid; ?>" class="pull-right" style="font-family: 'Sora', sans-serif; color:#e9c46a; display: flex;">
                        <h3><strong>Reffer</strong></h3>
                        <h3 style="margin: 20px"><strong>Post Job</strong></h3>
                      </a>
                    </div>
