        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                ...
                <div class="bg-light rounded p-4">
                    <p>Legacy is dedicated to helping students and recent graduates navigate the job market with ease and confidence. We offer a centralized platform where users can access job openings from multiple sources, including Telegram, WhatsApp, and Discord. By bringing all these opportunities together, we save candidates valuable time and simplify the job search process.</p>
                    <p>In addition to job listings, Legacy offers a unique Referral Section. This feature enables candidates to connect directly with employees who are willing to provide referrals, making it easier for users to secure opportunities in competitive fields.</p>
                    <p>Our mission is to empower candidates worldwide by streamlining their job search experience, enabling them to focus on achieving their career goals rather than surfing numerous sites for leads.</p>
                </div>
            </div>
        </div>
        <!-- About Us End -->
